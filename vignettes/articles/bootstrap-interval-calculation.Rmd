...
bootstrap_results_evenness <- bootstrap_cube(
  data_cube = processed_cube_even$data,
  fun = calc_evenness,
  grouping_var = "year",
  samples = 1000,
  seed = 123
...
bootstrap_results_richness %>%
  ...
  geom_errorbar(data = ci_richness,
                ...
                position = position_dodge(0.8), linewidth = 0.8) +
  # Settings
  labs(y = "richness", x = "", shape = "Legend:", colour = "Interval type:") +
...
The **vegan** (Oksanen et al., [2024](https://cran.r-project.org/web/packages/vegan/index.html)) and **iNEXT** (Hsieh et al., [2016](https://doi.org/10.1111/2041-210X.12613)) R packages provide such estimators, including **Chao1**, **Jackknife**, and coverage-based rarefaction/extrapolation, all of which are designed to handle unseen species and provide meaningful uncertainty estimates.
