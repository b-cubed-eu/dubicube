...
This function calculates a basic confidence interval from a bootstrap
...
This function is adapted from the internal function `basic.ci()` in the
...
#> [1,] 0.95    25.03   975.98 -2.017511 1.975176
```
