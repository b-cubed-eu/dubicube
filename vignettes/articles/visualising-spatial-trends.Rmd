...
Visualisation of indicator estimate and uncertainty within a spatial grid. A: Blur. B: Blur
and size. C: Transparency. D: Transparency and size. Created using R packages ggplot2 (Wickham,
2016), dplyr (Wickham et al., 2023), sf (Pebesma, 2018) and ggblur (mikefc, 2025) (code provided in
Langeraert et al., 2025, v1.4.0).
