...
Therefore, we perform leave-one-species-out cross-validation to investigate the impact of included species on the calculation of these values.
...
Indeed, looking at the individual error values reveals more outliers in later years.
