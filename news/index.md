...
- Add `process_cube_args` in filter function vignette
  [\#111](https://github.com/b-cubed-eu/dubicube/issues/111)
- Fix bug in rule functions after update example cube in vignette
  [\#112](https://github.com/b-cubed-eu/dubicube/issues/112)

## dubicube 0.12.2

- Update tutorials content based on internal review
- Add `process_cube_args` argument in
  [`filter_cube()`](https://b-cubed-eu.github.io/dubicube/reference/filter_cube.md)
- Change `"heatmap"` to `"rule"` option in
  [`plot.cube_diagnostics()`](https://b-cubed-eu.github.io/dubicube/reference/plot.cube_diagnostics.md)

## dubicube 0.12.0

- Implement data quality diagnostics and data filtering
  [\#90](https://github.com/b-cubed-eu/dubicube/issues/90)

## dubicube 0.11.1

- Add grant ID for Zenodo integration
  [\#94](https://github.com/b-cubed-eu/dubicube/issues/94)
- Fix ROR url bug
- Add publisher to metadata
- Make pkgdown lighter
  [\#93](https://github.com/b-cubed-eu/dubicube/issues/93)

## dubicube 0.11.0

- Improve figures of whole-cube versus group-specific tutorial
  [\#88](https://github.com/b-cubed-eu/dubicube/issues/88)
- Automate no bias option for boot functionality
  [\#89](https://github.com/b-cubed-eu/dubicube/issues/89)
