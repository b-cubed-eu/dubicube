...
where $\#$ is the counting operator and $\Phi^{-1}$ is the inverse cumulative density function of the standard normal distribution. B is the number of bootstrap samples.
...
For values between 0 and 1, we can use the logit function and its inverse (inv_logit):
