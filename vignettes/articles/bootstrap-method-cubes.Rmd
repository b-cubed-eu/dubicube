...
This returned a list of `"boot"` objects. We can convert this to a data frame 
...
This time, a data frame is returned since the **boot** package cannot be used with a reference group (see Bootstrap method section).
